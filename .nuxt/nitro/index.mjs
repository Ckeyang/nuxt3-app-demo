...
import htmlTemplate from '/Users/yangwenjie/programe/nuxt3-app/.nuxt/views/document.template.mjs';
import { renderToString as renderToString$2 } from 'vue/server-renderer';

const _runtimeConfig = {public:{NODE_ENV:"development",app:{baseURL:"\u002F",buildAssetsDir:"\u002F_nuxt\u002F",assetsPath:{},cdnURL:null}},private:{}};
...
const STATIC_ASSETS_BASE = "/_nuxt/Users/yangwenjie/programe/nuxt3-app/dist" + "/" + "1647831974";
const PAYLOAD_JS = "/payload.js";
const getClientManifest = cachedImport(() => import('/Users/yangwenjie/programe/nuxt3-app/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = cachedImport(() => import('/Users/yangwenjie/programe/nuxt3-app/.nuxt/dist/server/server.mjs'));
